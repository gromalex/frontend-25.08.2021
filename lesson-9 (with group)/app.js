...
const listElements = {
  freeGroup: document.querySelector('#freeGroup'),
  worksGroup: document.querySelector('#worksGroup'),
  personalGroup: document.querySelector('#personalGroup'),
  homeGroup: document.querySelector('#homeGroup')
}
...
function render () {
  ...
  data.forEach((toDo) => {
    ...
    const template = createToDoTemplate(toDo)
